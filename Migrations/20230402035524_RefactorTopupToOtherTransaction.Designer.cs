...
namespace ConstradeApi.Migrations
{
    ...
    [Migration("20230402035524_RefactorTopupToOtherTransaction")]
    partial class RefactorTopupToOtherTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConstradeApi.Entity.BoostProduct", b =>
                {
            ...
            modelBuilder.Entity("ConstradeApi.Entity.CommunityJoin", b =>
                {
                    b.Property<int>("CommunityJoinRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("community_join_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("CommunityJoinRequestId"));
                    ...
                    b.HasKey("CommunityJoinRequestId");

                    b.HasIndex("CommunityId");

                    b.HasIndex("UserId");

                    b.ToTable("community_join");
                });
            ...
            modelBuilder.Entity("ConstradeApi.Entity.CommunityPost", b =>
                {
            ...
            modelBuilder.Entity("ConstradeApi.Entity.CommunityPostComment", b =>
                {
            ...
            modelBuilder.Entity("ConstradeApi.Entity.CommunityPostLike", b =>
                {
                    b.Property<int>("CommunityPostLikeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("CommunityPostLikeId"));
            ...
            modelBuilder.Entity("ConstradeApi.Entity.OtherTransaction", b =>
                {
            ...
            modelBuilder.Entity("ConstradeApi.Entity.UserDeactivate", b =>
                {
            ...
            modelBuilder.Entity("ConstradeApi.Entity.CommunityPostComment", b =>
                {
                    ...
                    b.HasOne("ConstradeApi.Entity.CommunityPost", "Post")
                        .WithMany()
